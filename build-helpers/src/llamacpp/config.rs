...
impl CommonFlags {
    ...
    pub fn base() -> HashMap<String, String> {
        ...
        // CPU default everywhere; prevent accidental GPU toolchain requirements
        flags.insert("GGML_CPU".to_string(), "ON".to_string());
        flags.insert("GGML_CUDA".to_string(), "OFF".to_string());
        flags.insert("GGML_VULKAN".to_string(), "OFF".to_string());
        flags.insert("GGML_OPENCL".to_string(), "OFF".to_string());
        flags.insert("GGML_METAL".to_string(), "OFF".to_string());
        flags
    }
