import type { PermissionKey, User, UserGroup } from '../api/enpoints'
 ...
 */
function getPermissionCategory(permission: PermissionKey): string | null {
...
export function expandWildcardPermission(
  ...
  switch (wildcard) {
    case 'users::*':
      return ['users::read', 'users::edit', 'users::delete', 'users::create']
    case 'groups::*':
      return [
        'groups::read',
        'groups::edit',
...
export function getPermissionDisplayName(permission: PermissionKey): string {
  const displayNames: Record<string, string> = {
    ...
    'groups::*': 'All Group Permissions',
    'config::user-registration::read': 'View Registration Settings',
    'config::user-registration::edit': 'Edit Registration Settings',
    'chat::use': 'Use Chat',
