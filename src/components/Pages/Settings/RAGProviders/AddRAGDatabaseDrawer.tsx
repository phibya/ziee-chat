...
import { addNewDatabaseToRAGProvider, useAddRAGDatabaseDrawerStore } from '../../../../store'
...
export function AddRAGDatabaseDrawer({ open = false, onClose, providerId }: AddRAGDatabaseDrawerProps) {
