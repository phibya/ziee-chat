...
export function GeneralSettings() {
    return (
        <div className="space-y-6">
                ...
                <div className="border-b pb-4">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <div className="text-sm text-gray-500">Enable experimental features. They may be unstable or change at any time.</div>
                        </div>
                        <Switch size="small" />
                    </div>
                </div>
                ...
                <div className="border-b pb-4">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <div className="text-sm text-gray-500">Default location for messages and other user data.</div>
                            <div className="text-xs text-gray-400">/Users/royal/Library/Application Support/Jan/data</div>
                        </div>
                ...
                <div className="border-b pb-4 mt-4">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <div className="text-sm text-gray-500">Restore application to its initial state, erasing all models and chat history. This action is irreversible and recommended only if the application is corrupted.</div>
                        </div>
                ...
                <div className="border-b pb-4">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <div className="text-sm text-gray-500">Found a bug? Help us out by filing an issue on GitHub.</div>
                        </div>
            ...
            <div className="mt-6">
                <Title level={4} className="mb-4">Credits</Title>
                <div className="border-b pb-4">
                    <div>
                        <Text strong>Jan is built with ❤️ by the Menlo Team.</Text>
                        <div className="text-sm text-gray-500 mt-2">Special thanks to our open-source dependencies—especially llama.cpp and Tauri—and to our amazing AI</div>
                    </div>
                </div>
            </div>
        </div>
