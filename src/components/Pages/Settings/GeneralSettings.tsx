import {Button, Switch, Typography, Divider, Space, Flex} from 'antd'
...
export function GeneralSettings() {
    return (
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
            ...
            <div>
                <Flex justify="space-between" align="center">
                    <div>
                        ...
                        <div>
                            <Text type="secondary">Check if a newer version of Jan is available.</Text>
                        </div>
                    </div>
            ...
            <div>
                ...
                <Flex justify="space-between" align="center">
                    <div>
                        ...
                        <div>
                            <Text type="secondary">Enable experimental features. They may be unstable or change at any time.</Text>
                        </div>
                    </div>
                    <Switch size="small"/>
                </Flex>
            ...
            <div>
                <Title level={4}>Data Folder</Title>
                <Flex justify="space-between" align="center">
                    <div>
                        <Text strong>App Data</Text>
                        <div>
                            <Text type="secondary">Default location for messages and other user data.</Text>
                        </div>
                        <div>
                            <Text type="secondary" style={{ fontSize: '12px' }}>/Users/royal/Library/Application Support/Jan/data</Text>
                        </div>
                    </div>
            ...
            <div>
                ...
                <Flex justify="space-between" align="center">
                    <div>
                        ...
                        <div>
                            <Text type="secondary">Enable spell check for your threads.</Text>
                        </div>
                    </div>
                ...
                <Flex justify="space-between" align="center">
                    <div>
                        ...
                        <div>
                            <Text type="secondary">Restore application to its initial state, erasing all models and chat history. This action is irreversible and recommended only if the application is corrupted.</Text>
                        </div>
                    </div>
            ...
            <div>
                ...
                <Flex justify="space-between" align="center">
                    <div>
                        ...
                        <div>
                            <Text type="secondary">Learn how to use Jan and explore its features.</Text>
                        </div>
                    </div>
                ...
                <Flex justify="space-between" align="center">
                    <div>
                        ...
                        <div>
                            <Text type="secondary">See what's new in the latest version of Jan.</Text>
                        </div>
                    </div>
            ...
            <div>
                ...
                <Flex justify="space-between" align="center">
                    <div>
                        ...
                        <div>
                            <Text type="secondary">Join our community for support and discussions.</Text>
                        </div>
                    </div>
                    <Button type="text">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            ...
            <div>
                ...
                <Flex justify="space-between" align="center">
                    <div>
                        ...
                        <div>
                            <Text type="secondary">Found a bug? Help us out by filing an issue on GitHub.</Text>
                        </div>
                    </div>
