...
export const DeviceSelectionSection: React.FC<DeviceSelectionSectionProps> = ({
  ...
  const selectedDeviceType =
    form.getFieldValue(['settings', 'device_type']) || 'cpu'
  const selectedDeviceIds = form.getFieldValue(['settings', 'device_ids']) || []
