...
import { AddLocalModelDownloadModal } from './AddLocalModelDownloadModal'
import { AddLocalModelUploadModal } from './AddLocalModelUploadModal'
import { AddProviderModal } from './AddProviderModal'
import { AddRemoteModelModal } from './AddRemoteModelModal'
import { EditLocalModelModal } from './EditLocalModelModal'
import { EditRemoteModelModal } from './EditRemoteModelModal'
...
export function ProvidersSettings() {
  ...
  return (
    <Layout>
      ...
      <AddLocalModelUploadModal />
      <AddLocalModelDownloadModal />
      <AddRemoteModelModal />

      <EditLocalModelModal />
      <EditRemoteModelModal />
    </Layout>
  )
}
