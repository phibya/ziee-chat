...
function TemplateAssistantCard({ assistant }: TemplateAssistantCardProps) {
  ...
  return (
    <Card hoverable className="w-full mb-3">
      <Flex className="w-full flex-col flex-1 gap-2">
        <Flex className="flex-col flex-1 gap-1 w-full">
        ...
        {/* Expanded Details */}
        {expanded && (
          <Flex vertical className="gap-3 mt-2 p-3 rounded">
            <div>
