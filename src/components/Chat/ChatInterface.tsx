      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{ borderColor: appTheme.borderLight }}
          >
            <div className="flex gap-2">
              <button
                className="px-3 py-2 bg-transparent border rounded-md text-sm cursor-pointer"
                style={{
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="p-2 border-none rounded-md cursor-pointer"
                style={{
