...
export type RAGIndexingErrorCode =
...
export type RAGInstanceErrorCode =
  | 'embedding_model_not_config'
  | 'embedding_model_not_found'
  | 'embedding_model_test_failed'
...
export type RAGSimpleGraphQueryMode =
  | 'local'
  | 'global'
  | 'hybrid'
  | 'naive'
...
export const ApiEndpoints = {
  ...
  'Admin.createSystemRagInstance':
    'POST /api/admin/rag/providers/{provider_id}/instances',
  ...
  'Admin.deleteSystemRagInstance':
    'DELETE /api/admin/rag/instances/{instance_id}',
  ...
  'Admin.getGroupRagProviders':
    'GET /api/admin/groups/{group_id}/rag_providers',
  ...
  'Admin.listSystemRagInstances':
    'GET /api/admin/rag/providers/{provider_id}/instances',
  ...
  'Rag.deleteInstanceFile':
    'DELETE /api/rag/instances/{instance_id}/files/{file_id}',
  ...
  'Rag.subscribeInstanceStatus':
    'GET /api/rag/instances/{instance_id}/status/stream',
  'Rag.toggleInstanceActivate':
    'PUT /api/rag/instances/{instance_id}/toggle-activate',
