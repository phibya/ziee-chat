...
export const ApiEndpoints = {
  ...
  'Admin.assignRagProviderToGroup':
    'POST /api/admin/user-groups/{group_id}/rag-providers',
  ...
  'Admin.listUserGroupRagProviderRelationships':
    'GET /api/admin/user-group-rag-providers',
  ...
  'Admin.removeRagProviderFromGroup':
    'DELETE /api/admin/user-groups/{group_id}/rag-providers/{provider_id}',
  ...
  'Admin.updateGroupRagProviderPermissions':
    'PUT /api/admin/user-groups/{group_id}/rag-providers/{provider_id}',
...
export type ApiEndpointParameters = {
  ...
  'Admin.assignRagProviderToGroup': {
    group_id: string
  } & AssignRAGProviderToGroupRequest
  ...
  'Rag.addFilesToInstance': {
    instance_id: string
  } & AddFilesToRAGInstanceRequest
