...
import type {EngineInfo} from '../types/api/engine'
...
// Helper functions
export const getEngineByType = (engines: EngineInfo[], engineType: string): EngineInfo | undefined => {
...
export const searchEngines = (engines: EngineInfo[], query: string): EngineInfo[] => {
