...
pub fn main() -> anyhow::Result<()> {
    ...
    let vec_imgs = match args.images {
        Some(imgs) => imgs,
        None => vec![
            "candle_server-examples/examples/stable-diffusion/assets/stable-diffusion-xl.jpg"
                .to_string(),
            "candle_server-examples/examples/yolo-v8/assets/bike.jpg".to_string(),
        ],
    };
...
pub fn tokenize_sequences(
    ...
    let vec_seq = match sequences {
        ...
        None => vec![
            ...
            "a robot holding a candle_server".to_string(),
        ],
    };
    let mut tokens = vec![];
