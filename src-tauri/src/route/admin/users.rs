...
pub fn admin_user_routes() -> ApiRouter {
    ApiRouter::new()
        ...
        .api_route(
            "/users",
            get_with(api::user::list_users, |op| {
        ...
        .api_route(
            "/users/{user_id}",
            put_with(api::user::update_user, |op| {
        ...
        .api_route(
            ...
            post_with(api::user::toggle_user_active, |op| {
            ...
            .layer(middleware::from_fn(
                api::middleware::users_toggle_status_middleware,
            )),
        )
        .api_route(
            "/users/reset-password",
            post_with(api::user::reset_user_password, |op| {
            ...
            .layer(middleware::from_fn(
                api::middleware::users_reset_password_middleware,
            )),
        )
        .api_route(
            "/users",
            post_with(api::user::create_user, |op| {
        ...
        .api_route(
            "/users/{user_id}",
            delete_with(api::user::delete_user, |op| {
