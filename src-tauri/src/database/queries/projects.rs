...
pub async fn get_project_by_id(
    ...
    if let Some(project_db) = project_result {
        // Get document count
        let document_count: Option<i64> = sqlx::query_scalar(
        ...
        let conversation_count: Option<i64> = sqlx::query_scalar(
...
pub async fn list_projects(
    ...
    for project_db in projects_db {
        ...
        projects.push(Project::from_db(project_db, document_count, conversation_count));
    }
...
pub async fn link_conversation_to_project(
    ...
    let conversation_check: Option<i64> = sqlx::query_scalar(
